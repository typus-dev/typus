 ...
 * Find model file
 */
async function findModelFile(plugin, modelName) {
 ...
 */
async function loadAndValidateModel(modelPath, modelName) {
    try {
 ...
 */
async function createSeedTemplate(plugin, modelName) {
 ...
 * Load seed data
 */
async function loadSeedData(plugin) {
...
//# sourceMappingURL=db-instant.js.map